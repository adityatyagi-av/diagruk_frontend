...
const NablSection = () => {
  return (
    ...
    <div className='py-20'>
        ...
        <p className='text-4xl ml-28 leading-9 mt-6 text-gray-500 font-medium'>transform your career</p>
        <div className="">
        ...
        <p className='text-2xl ml-4 leading-10 font-medium'>Basics of NABL</p>
