...
const Home3 = () => {
  return (
    <>
    <div className='flex max-h-full md:max-h-screen justify-center h-[100vh] '>
      
  <div className='flex items-center flex-col items-center max-h-full max-h-full md:max-h-screen justify-center h-[100vh] '>
...
<div className='flex max-h-full md:max-h-screen justify-center max-h-full justify-center items-end'>
  <div className='new  bg-red flex-col max-h-full max-w-full w-[500px] h-[600px] mx-auto'> 
